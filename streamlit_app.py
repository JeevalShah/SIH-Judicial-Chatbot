...
def main():
    ...
    st.title("⚖️ Judiciary Assistance System")
    ...
    with st.sidebar:
        st.subheader("About")
        st.write("This AI assistant is designed to help with judiciary system. Feel free to ask any questions about pending cases, judicial procedures, etc.")
        
        st.subheader("Need More Help?")
        st.info("If you need further assistance, consider contacting our support.")
